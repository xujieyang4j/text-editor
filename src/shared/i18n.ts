...
const ZH = {
  ...
  lineEndingPickerPlaceholder: '选择换行符…', encodingActionPickerPlaceholder: '选择编码操作…', encodingPickerPlaceholder: '选择保存编码…', reopenEncodingPickerPlaceholder: '以编码重新打开…', current: '当前',
  // Dynamic notification and aria-label values are prefixes; append the formatted EOL/encoding label.
  lineEndingChanged: '保存换行符：', encodingChanged: '保存编码：', lineEndingAriaLabel: '选择换行符，当前为', encodingAriaLabel: '编码操作，当前为',
...
const EN: Record<TranslationKey, string> = {
  ...
  lineEndingPickerPlaceholder: 'Select line ending…', encodingActionPickerPlaceholder: 'Choose an encoding action…', encodingPickerPlaceholder: 'Select encoding for save…', reopenEncodingPickerPlaceholder: 'Reopen with encoding…', current: 'Current',
  lineEndingChanged: 'Save line endings as ', encodingChanged: 'Save encoding as ', lineEndingAriaLabel: 'Select line ending, currently ', encodingAriaLabel: 'Encoding actions, currently ',
...
const COMMAND_ZH: Partial<Record<MenuEvent, string>> = {
  ...
  'toggle-preview': '切换 Markdown 预览', 'open-in-browser': '在浏览器中打开', 'select-language': '设置语法…', 'select-line-ending': '选择换行符…', 'select-encoding': '选择保存编码…', 'reopen-with-encoding': '以编码重新打开…', 'command-palette': '命令面板…',
