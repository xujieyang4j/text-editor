...
const ZH = {
  ...
  lineEndingPickerPlaceholder: '选择换行符…', encodingPickerPlaceholder: '选择编码…', current: '当前',
  // Dynamic notification and aria-label values are prefixes; append the formatted EOL/encoding label.
  lineEndingChanged: '保存换行符：', encodingChanged: '保存编码：', lineEndingAriaLabel: '选择换行符，当前为', encodingAriaLabel: '选择编码，当前为',
...
const EN: Record<TranslationKey, string> = {
  ...
  lineEndingPickerPlaceholder: 'Select line ending…', encodingPickerPlaceholder: 'Select encoding…', current: 'Current',
  lineEndingChanged: 'Save line endings as ', encodingChanged: 'Save encoding as ', lineEndingAriaLabel: 'Select line ending, currently ', encodingAriaLabel: 'Select encoding, currently ',
...
const COMMAND_ZH: Partial<Record<MenuEvent, string>> = {
  ...
  find: '查找', 'find-next': '在当前文档中查找下一个', 'find-previous': '在当前文档中查找上一个', replace: '替换', 'find-in-files': '在文件中查找…', 'replace-in-files': '在文件中替换…', 'undo-replace-in-files': '撤销上次文件替换', 'find-results-next': '下一个查找结果', 'find-results-prev': '上一个查找结果',
  ...
  'toggle-comment': '切换行注释', 'toggle-block-comment': '切换块注释', 'move-line-up': '上移行', 'move-line-down': '下移行', 'copy-line-up': '向上复制行', 'copy-line-down': '向下复制行', 'duplicate-selection': '复制行/选区', 'delete-line': '删除行', 'delete-word-backward': '删除前一个单词', 'delete-word-forward': '删除后一个单词', 'delete-to-line-start': '删除至行首', 'delete-to-line-end': '删除至行尾', 'insert-blank-line-above': '在上方新建空行', 'insert-blank-line': '在下方新建空行', 'transpose-characters': '转置相邻字符', 'sort-lines': '升序排列行', 'sort-lines-descending': '降序排列行', 'reverse-lines': '反转行顺序', 'unique-lines': '删除重复行',
  'to-upper-case': '转为大写', 'to-lower-case': '转为小写', 'to-title-case': '转为标题格式', 'join-lines': '合并行', 'trim-trailing-whitespace': '删除行尾空白', 'indent-selection': '增加缩进', 'outdent-selection': '减少缩进', 'reindent-selection': '自动重新缩进选区', 'convert-eol-lf': '将换行符转换为 LF', 'convert-eol-crlf': '将换行符转换为 CRLF', 'convert-eol-cr': '将换行符转换为 CR',
  ...
  'toggle-preview': '切换 Markdown 预览', 'open-in-browser': '在浏览器中打开', 'select-language': '设置语法…', 'select-line-ending': '选择换行符…', 'select-encoding': '选择编码…', 'command-palette': '命令面板…',
  ...
  'lsp-hover': '显示悬停信息', 'lsp-definition': '转到定义', 'lsp-references': '查找引用', 'lsp-rename': '重命名符号', 'toggle-language-servers': '显示语言服务器',
