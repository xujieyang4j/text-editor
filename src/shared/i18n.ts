...
const COMMAND_ZH: Partial<Record<MenuEvent, string>> = {
  ...
  'toggle-comment': '切换行注释', 'toggle-block-comment': '切换块注释', 'move-line-up': '上移行', 'move-line-down': '下移行', 'copy-line-up': '向上复制行', 'copy-line-down': '向下复制行', 'duplicate-selection': '复制行/选区', 'delete-line': '删除行', 'transpose-characters': '转置相邻字符', 'sort-lines': '排序行',
