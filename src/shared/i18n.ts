...
const ZH = {
  ...
  commandPalette: '命令面板…', setSyntax: '设置语法…', toggleSidebar: '切换侧边栏', toggleMinimap: '切换缩略图', distractionFree: '专注模式', toggleSpellCheck: '切换拼写检查', toggleWrap: '切换自动换行', toggleTheme: '切换主题', selectColorScheme: '选择配色方案…',
  ...
  build: '构建', formatDocument: '格式化文档', selectBuildSystem: '选择构建系统…', importSublimeBuild: '导入 Sublime 构建系统…', toggleBuildOutput: '切换构建输出', configureLanguageTool: '配置语言工具…',
...
const EN: Record<TranslationKey, string> = {
  ...
  commandPalette: 'Command Palette…', setSyntax: 'Set Syntax…', toggleSidebar: 'Toggle Sidebar', toggleMinimap: 'Toggle Minimap', distractionFree: 'Distraction Free Mode', toggleSpellCheck: 'Toggle Spell Check', toggleWrap: 'Toggle Word Wrap', toggleTheme: 'Toggle Theme', selectColorScheme: 'Select Color Scheme…',
  ...
  build: 'Build', formatDocument: 'Format Document', selectBuildSystem: 'Select Build System…', importSublimeBuild: 'Import Sublime Build System…', toggleBuildOutput: 'Toggle Build Output', configureLanguageTool: 'Configure Language Tool…',
...
const COMMAND_ZH: Partial<Record<MenuEvent, string>> = {
  ...
  'add-cursor-above': '在上方添加光标', 'add-cursor-below': '在下方添加光标', 'select-next-occurrence': '选择下一个匹配项', 'select-all-occurrences': '选择全部匹配项', 'split-selection-lines': '按行拆分选区',
  ...
  'toggle-minimap': '切换缩略图', 'toggle-distraction-free': '切换专注模式', 'toggle-spell-check': '切换拼写检查', 'toggle-word-wrap': '切换自动换行', 'toggle-theme': '切换明暗主题', 'select-color-scheme': '选择配色方案…', 'font-zoom-in': '放大字体', 'font-zoom-out': '缩小字体', 'font-zoom-reset': '重置字体大小',
  'toggle-preview': '切换 Markdown 预览', 'open-in-browser': '在浏览器中打开', 'select-language': '设置语法…', 'command-palette': '命令面板…',
  build: '构建', 'select-build-system': '选择构建系统…', 'import-sublime-build': '导入 Sublime 构建系统…', 'format-document': '格式化文档', 'toggle-problems': '切换构建输出', 'language-tools': '配置语言工具…',
