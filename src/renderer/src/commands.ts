...
export const COMMANDS: Command[] = [
  ...
  { id: 'open-file-with-encoding', title: 'File: Open File with Encoding…' },
  ...
  { id: 'select-encoding', title: 'File: Select Encoding for Save…' },
  { id: 'reopen-with-encoding', title: 'File: Reopen with Encoding…' },
  ...
  { id: 'find-next', title: 'Find: Find Next in Current Document', hint: 'F3' },
  { id: 'find-previous', title: 'Find: Find Previous in Current Document', hint: 'Shift+F3' },
  ...
  { id: 'undo-selection', title: 'Selection: Undo Selection', hint: 'Ctrl/Cmd+U' },
  { id: 'redo-selection', title: 'Selection: Redo Selection', hint: 'macOS: Cmd+Shift+U · Win/Linux: Alt+U' },
  { id: 'select-next-occurrence', title: 'Selection: Add Next Occurrence', hint: 'Ctrl/Cmd+D' },
  { id: 'skip-current-occurrence', title: 'Selection: Skip Current Occurrence' },
  { id: 'remove-last-cursor', title: 'Selection: Remove Last Cursor' },
  { id: 'select-all-occurrences', title: 'Selection: Select All Occurrences', hint: 'Alt+F3' },
  { id: 'add-cursors-line-starts', title: 'Selection: Add Cursors to Line Starts' },
  { id: 'add-cursors-line-ends', title: 'Selection: Add Cursors to Line Ends', hint: 'Shift+Alt+I' },
  ...
  { id: 'sort-lines', title: 'Edit: Sort Lines Ascending' },
  ...
  { id: 'reveal-active-file-in-sidebar', title: 'View: Reveal Active File in Sidebar' },
