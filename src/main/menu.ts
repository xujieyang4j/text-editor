  ...
  const template: MenuItemConstructorOptions[] = [
      ...
      : []),
    {
      ...
      submenu: [
        ...
        item('Open File with Encoding…', 'open-file-with-encoding'),
        ...
        item('Select Encoding for Save…', 'select-encoding'),
        item('Reopen with Encoding…', 'reopen-with-encoding'),
        item('Select Line Ending…', 'select-line-ending'),
    ...
    },
    {
      ...
      submenu: [
        ...
        item('Reveal Active File in Sidebar', 'reveal-active-file-in-sidebar'),
